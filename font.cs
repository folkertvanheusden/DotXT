...
internal enum FontName { CGA, VGA }

class Fonts
{
    static byte [] glyphs_cga = new byte[] {
    ...
    static int glyphs_cga_width = 8;
    static int glyphs_cga_height = 8;

    static byte [] glyphs_vga = new byte[] {
    ...
    static int glyphs_vga_width = 8;
    static int glyphs_vga_height = 14;

    public Fonts()
    {
    }

    public FontDescriptor get_font(FontName font)
    {
        FontDescriptor descriptor = new();
        if (font == FontName.VGA)
        {
            descriptor.width = glyphs_vga_width;
            descriptor.height = glyphs_vga_height;
            descriptor.pixels = glyphs_vga;
        }
        else
        {
            descriptor.width = glyphs_cga_width;
            descriptor.height = glyphs_cga_height;
            descriptor.pixels = glyphs_cga;
        }
        return descriptor;
    }   
}
